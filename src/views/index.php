...
<body>
  ...
  <section id="about-us">
    ...
    <div class="know-us">
      ...
      <div class="text">
        <p> Apasionados por el desarrollo personal, nuestra principal misión es ser el <strong> punto de encuentro </strong> para todos aquellos interesados en este ámbito.</p>
        <p> Os ofrecemos un <strong> amplio catálogo de libros </strong> sobre finanzas, habilidades sociales, salud mental, entre otros, que os guiarán para dar vuestra mejor versión.</p>
        <p> También se incluye un apartado de posts donde podéis <strong> valorar y aportar conocimiento </strong> a la comunidad sobre diversos tópicos, experiencias y anécdotas.</p>
      </div>
    </div>
